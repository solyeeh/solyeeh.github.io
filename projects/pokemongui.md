...
This was the first big project that I had in my coding career. We implemented all of the things we learned throughout the course of the semester such as how to implement sorting, seperate data structures, and use our own sorting methods such as the Java List sort method. 
